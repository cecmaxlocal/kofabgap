...
DIM fileLineFreebasic AS STRING
DIM fileLineQBasic AS STRING
...
DIM resultFreebasic AS Integer
DIM resultQBasic AS Integer
...
'     DECLARE FUNCTION thong ALIAS "thong" (BYVAL hostshort AS USHORT) AS USHORT
' END DECLARE
...
''    ```freebasic
    ...
    Declare Function AddNumbersFreebasic(ByVal a As Integer, ByVal b As Integer) As Integer
    Declare Function AddNumbersQBasic(ByVal a As Integer, ByVal b As Integer) As Integer
''    ```
''    *Example (`main.bas`):*
''    ```freebasic
    ' main.bas
