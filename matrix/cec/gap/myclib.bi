...
'' Classic freebasic notion checkup library files to documentation linear expression geometry algarithm
'' Name static reference linear object oriented Freebasic and QBasic to form and dialog static local its
'' PP and PT  form the dialog about the questing of analysis systematic to make formal code list until
'' Create analysis:.
