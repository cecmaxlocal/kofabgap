...
DIM AS INTEGER fileNumberFreebasic = FREEFILE ' Get an unused file number
DIM AS INTEGER fileNumberQBasic = FREEFILE ' Get an unused file number
...
'    ```freebasic
    ...
    Dim num1Freebasic As Integer = 10
    Dim num2QBasic As Integer = 20
    Dim sumVsBasic As Integer
