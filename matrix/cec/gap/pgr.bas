...
Select Case SideList
   Case 1:
           Print "Initial Blue Berry Show Cout"; BlueBerryColt.DetailsCout
   Case 2:
           Print "Initial Blue Berry Show Map"; BlueBerryColt.DetailsMap
   Case 3:
           Print "Initial Blue Berry Show Blue"; BlueBerryColt.DetailsBlue
   Case 4 To 5:
           Print "Initial Blue Berry Show..."
End Select
...
Sub BlueCherry (ByRef  CoutList As Long)
   ...
   Let WorkScript = WorkList '' learn book  
...
Declare Function MContext(ByRef Mention As Long, ByRef  Potatoes As Long) As Long

Input Mention 
Print "Mention List: "; Potatoes 
...
searchWord = ToLowerCat(searchWord) ' Convert search word to lowercase for case-insensitive search
